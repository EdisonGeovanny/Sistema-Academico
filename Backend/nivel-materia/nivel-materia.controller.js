const User = require('./nivel-materia.dao');
const jwt = require('jsonwebtoken');
const bcrypt = require('bcryptjs');
const SECRET_KEY = 'secretkey1234';

//crear Periodo
exports.createNv = (req, res, next) => {
    const newUser = {
...
exports.deleteNv = async (req, res) => {
    try {
        let materia = await User.findById(req.params.id);
...
exports.updateNv = async (req, res) => {
    try {
        const { Nivel, Asignatura, Area } = req.body;
...
exports.searchNv = async (req, res) => {
    try {
